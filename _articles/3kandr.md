...
It's hard to find the code examples and my Mac doesn't do a great job parsing the code from the PDF. I know source control wasn't a thing in the 80s but there are plenty of examples online which alleviate this.

Also, it was written ages ago and some of the questions will just not make sense. Take 5-7 for example: I profiled it and there wasn't much of a difference. Why? Cause my computer ran it ez-pz. 
